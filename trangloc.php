            ...
            <div class="content__right">
                ...
                <div class="content__right__money__adress">
                    <div class="content__right__border">
                        <div class="content__right__white">
                            <a href="" class="content__right__white__link">
                                <img class="content__right__white__link__img" src="./images/slide1.jpg" alt="">
                            </a>
                    ...
                    <div class="content__right__border">
                        <div class="content__right__white">
                            <a href="" class="content__right__white__link">
                                <img class="content__right__white__link__img" src="./images/slide2.jpg" alt="">
                            </a>
                            <div class="content__right__white__money__adress">
                                <span class="content__right__white__money__adress__span">
                                    Phòng trọ siêu xinh
                    ...
                    <div class="content__right__border">
                        <div class="content__right__white">
                            <a href="" class="content__right__white__link">
                                <img class="content__right__white__link__img" src="./images/slide3.jpg" alt="">
                            </a>
                            <div class="content__right__white__money__adress">
                                <span class="content__right__white__money__adress__span">
                                    Phòng trọ siêu xinh
                    ...
                    <div class="content__right__border">
                        <div class="content__right__white">
                            <a href="" class="content__right__white__link">
                                <img class="content__right__white__link__img" src="./images/slide4.jpg" alt="">
                            </a>
                            <div class="content__right__white__money__adress">
                                <span class="content__right__white__money__adress__span">
                                    Phòng trọ siêu xinh
